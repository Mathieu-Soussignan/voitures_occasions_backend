...
learning_curve_data = {
    ...
    "training_scores": train_mean.tolist(),
    "validation_scores": test_mean.tolist()
}

with open("../static/learning_curve.json", "w") as json_file:
    json.dump(learning_curve_data, json_file)

print("Learning curve data exported to static/learning_curve.json")